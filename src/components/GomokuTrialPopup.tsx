...
export const GomokuTrialPopup: React.FC<{
  open: boolean;
  onDismiss: () => void;
  onTry: () => void;
    ...
    <AnimatePresence>
      {open ? (
        <motion.div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="gomoku-trial-title"
        >
          <motion.div
          ...
          >
            <p
              id="gomoku-trial-title"
              className="text-base md:text-lg font-black text-rk-amber-950 leading-snug"
            >
              五目並べをお試し公開しています
            </p>
            <p className="mt-2 text-xs font-medium text-rk-amber-900/85 leading-relaxed">
              らくだ珈琲のテーブルから遊べます。13×13と15×15、星ハンデ、座標付きです。
            </p>
...
export default GomokuTrialPopup;
