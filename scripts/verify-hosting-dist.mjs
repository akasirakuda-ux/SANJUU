...
if (!m) {
  console.error('[verify-hosting-dist] dist/index.html に /assets/index-*.js の参照がありません。');
  process.exit(1);
}

const jsPath = path.join(root, 'dist', 'assets', m[1]);
...
console.log('[verify-hosting-dist] OK', m[1], `(${kb} KB)`);
